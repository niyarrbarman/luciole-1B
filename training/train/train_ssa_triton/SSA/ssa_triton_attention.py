# Copyright (c) 2025, SSA Triton Attention - Megatron-compatible module
# Uses the triton kernel (tutorial-based structure with stage-based causal,
...
class SSATritonAttention(MegatronModule):
    """
    SSA attention using Triton kernels (tutorial-based structure).
    ...
    def forward(
        ...
        """
        Forward pass using Triton-fused SSA FlashAttention.
        ...
        assert packed_seq_params is None, (
            "Packed sequence not supported by SSATritonAttention."
        )
