...
OUTPUT_JSON=${OUTPUT:-"/tmpdir/m24047brmn/nemo_1b/output/generation_triton_v4_${SLURM_JOB_ID}.json"}

echo "=========================================="
echo "Generating Text: Baby Luciole SSA Triton v4"
...
apptainer exec \
    ...
    python3 /work/m24047/m24047brmn/nemo/OpenLLM-BPI-Training/training/train/test/generate_triton_v4.py \
