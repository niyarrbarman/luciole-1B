#!/bin/bash
#SBATCH -J eval_bbyluc_ppl_triton
#SBATCH -N 1
#SBATCH -n 1
...
CHECKPOINT_PATH=${CHECKPOINT:-"/tmpdir/m24047brmn/nemo_1b/output/baby_luciole-ssa-triton/checkpoints/baby_luciole-ssa-triton-step=0029999-last"}
...
OUTPUT_FILE=${OUTPUT:-"/tmpdir/m24047brmn/nemo_1b/output/perplexity_triton_fw_wiki_${SLURM_JOB_ID}.json"}

echo "=========================================="
echo "Evaluating Perplexity: Baby Luciole SSA Triton"
...
apptainer exec \
    ...
    python3 /work/m24047/m24047brmn/nemo/OpenLLM-BPI-Training/training/train/train_ssa_triton/eval_perplexity_triton.py \
