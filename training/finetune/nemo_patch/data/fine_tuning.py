...
class FineTuningDataModule(pl.LightningDataModule):
    ...
    def prepare_data(self) -> None:
        ...
        if self.packed_sequence_size > 0:
            from .packed_sequence import prepare_packed_sequence_data

            if not self.train_path_packed.is_file() or self.force:
            ...
            if not self.validation_path_packed.is_file() or self.force:
                prepare_packed_sequence_data(
