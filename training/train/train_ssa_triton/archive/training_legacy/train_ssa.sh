...
NAME=${NAME:-"baby_luciole-ssa-test"}
SEED=${SEED:-1234}
...
srun apptainer exec \
    ...
    torchrun \
        ...
        /work/m24047/m24047brmn/nemo/OpenLLM-BPI-Training/training/train/train_ssa_triton/train_ssa.py \
        --datamix "$DATAMIX" \
...
status=$?
echo "=========================================="
echo "SSA Training finished with status $status"
echo "=========================================="
exit $status
